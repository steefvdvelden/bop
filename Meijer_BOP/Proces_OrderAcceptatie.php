    ...
    <body>	
   	<?php
	   	if ($procesConfig->formName!=""){
			...
			// Eerste activiteit				
			$proces->includeActiviteit(1, 0, 0 ,"Activiteit_OrdersInProductie.php");

			// Beslissing 
			$proces->includeBeslissing(2, 0, "Beslissing_Check_Acceptatie.php", 3, 4);
				
			// Eerste pad, tweede activiteit
			$proces->includeActiviteit(3, 1, 1, "Activiteit_Show_OrderGeaccepteerd.php");

			// Tweede pad, derde activiteit
			$proces->includeActiviteit(4, 2, 2, "Activiteit_Show_Order_Niet_Geaccepteerd.php");
