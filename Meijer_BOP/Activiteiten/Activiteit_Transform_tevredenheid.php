<?php
	...
	$activiteit->xslSheet=Utils::GetBaseUrl() . "TransformSheets/TransformTevredenheid.xsl";
	...
	$activiteit->elementName ="tevredenheids";
	...
	$activiteit->elementOut = "transformedTev";
	$activiteit->nsURIOut = "http://localhost/Hanze_BOP/Kooij_BOP/transform";
	...
	$activiteit->naam="Tranformeer tevredenheid op";
	...
	$activiteit->completedTekst="De gegevens zijn getransformeerd";
	
	// De tekst op de knop in de proces flow
	$activiteit->button="Transformeer tevredenheid";
	?>
